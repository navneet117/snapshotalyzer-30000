...
@click.option('--project', default=None,
    help="Only snapshots for project (tag Project:<nam>)")
...
@click.option('--project', default=None,
    help="Only volumes for project (tag Project:<nam>)")
def list_volumess(project):
    "List EC2 volumes"
...
@click.option('--project', default=None,
    help="Only instances for project (tag Project:<nam>)")
